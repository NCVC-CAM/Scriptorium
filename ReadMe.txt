========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : Scriptorium
========================================================================


AppWizard が生成した Scriptorium には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには Scriptorium を構成している各ファイルの概要説明が含まれています。
...
Scriptorium.h
    ...
    みます） をインクルードし、また CScriptoriumApp アプリケーションクラスを宣
    言します。

Scriptorium.cpp
    このファイルは CScriptoriumApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\Scriptorium.ico
    ...
    ルです。このアイコンはリソース ファイル Scriptorium.rc によってインクルード
    されます。
...
ScriptoriumDlg.h, ScriptoriumDlg.cpp - ダイアログ
    これらのファイルは CScriptoriumDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な Scriptorium.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) Scriptorium.pch 
